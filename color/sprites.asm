...
SpritePaletteAssignments: ; Characters on the overworld
	...
	; 0x41: SPRITE_PAPER_SHEET
	db SPR_PAL_BROWN

	; 0x42: SPRITE_BOOK_MAP_DEX
	db SPR_PAL_ORANGE

	; 0x43: SPRITE_CLIPBOARD
	db SPR_PAL_BROWN

	; 0x44: SPRITE_SNORLAX
	db SPR_PAL_ORANGE

	; 0x45: SPRITE_OLD_AMBER_COPY
	db SPR_PAL_ROCK

	; 0x46: SPRITE_OLD_AMBER
	db SPR_PAL_ROCK

	; 0x47: SPRITE_LYING_OLD_MAN_UNUSED_1
	db SPR_PAL_BROWN

	; 0x48: SPRITE_LYING_OLD_MAN_UNUSED_2
	db SPR_PAL_BROWN

	; 0x49: SPRITE_LYING_OLD_MAN
	db SPR_PAL_BROWN
