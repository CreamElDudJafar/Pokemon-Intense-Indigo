...
PokemonMansion3F_Object:
	...
	object_event 26, 15, SPRITE_SCIENTIST, STAY, LEFT, TEXT_POKEMONMANSION3F_SCIENTIST, OPP_SCIENTIST, 12
	object_event 12, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION3F_MAX_POTION, RARE_CANDY
	object_event 18,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION3F_IRON, RARE_CANDY
