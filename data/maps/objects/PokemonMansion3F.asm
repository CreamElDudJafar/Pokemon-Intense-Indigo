...
PokemonMansion3F_Object:
	...
	object_event 18, 4, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION3F_MAX_POTION, ETHER
	object_event 19, 4, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION3F_IRON, ETHER
