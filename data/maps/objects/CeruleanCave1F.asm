...
CeruleanCave1F_Object:
	...
	warp_event 0, 6, POWER_PLANT, 1

	def_bg_events

	def_object_events
	object_event 0, 15, SPRITE_MONSTER, STAY, NONE, TEXT_CERULEANCAVE1F_FULL_RESTORE, FULL_RESTORE
	object_event 19, 3, SPRITE_FAIRY, STAY, NONE, TEXT_CERULEANCAVE1F_MAX_ELIXER, POKE_DOLL
	object_event 5, 0, SPRITE_MONSTER, STAY, NONE, TEXT_CERULEANCAVE1F_NUGGET, NUGGET
