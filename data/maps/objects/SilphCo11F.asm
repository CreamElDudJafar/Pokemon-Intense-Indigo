...
SilphCo11F_Object:
	...
	def_object_events
	object_event 14, 5, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO11F_SILPH_PRESIDENT
	object_event 7, 5, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_SILPHCO11F_BEAUTY
	object_event 6, 9, SPRITE_GIOVANNI, STAY, DOWN, TEXT_SILPHCO11F_GIOVANNI, OPP_GIOVANNI, 2
	object_event 3, 1, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO11F_ROCKET1, OPP_ENGINEER, 175
	object_event 5, 14, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO11F_ROCKET2, OPP_ENGINEER, 125
