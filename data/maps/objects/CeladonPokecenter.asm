...
CeladonPokecenter_Object:
	...
	object_event 7, 3, SPRITE_DAISY, WALK, LEFT_RIGHT, TEXT_CELADONPOKECENTER_GENTLEMAN
	object_event 10, 5, SPRITE_GIRL, WALK, ANY_DIR, TEXT_CELADONPOKECENTER_BEAUTY
	object_event 11, 2, SPRITE_SILPH_WORKER_M, STAY, DOWN, TEXT_CELADONPOKECENTER_GENTLEMAN
