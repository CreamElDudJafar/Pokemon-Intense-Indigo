...
Museum1F_Object:
	...
	object_event 1, 4, SPRITE_SCIENTIST, STAY, UP, TEXT_MUSEUM1F_GAMBLER
	object_event 15, 2, SPRITE_LORELEI, STAY, DOWN, TEXT_MUSEUM1F_SCIENTIST2
	object_event 9, 2, SPRITE_SILPH_PRESIDENT, STAY, NONE, TEXT_MUSEUM1F_SCIENTIST3
