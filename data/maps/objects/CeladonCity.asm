...
CeladonCity_Object:
	...
	bg_event 41, 11, TEXT_CELADONCITY_MANSION_SIGN
	...
	def_object_events
	object_event 36, 19, SPRITE_ROCKET, WALK, ANY_DIR, TEXT_CELADONCITY_LITTLE_GIRL
	object_event 11, 28, SPRITE_ROCKET, STAY, UP, TEXT_CELADONCITY_GRAMPS1
	object_event 23, 25, SPRITE_ROCKET, WALK, UP_DOWN, TEXT_CELADONCITY_GIRL
	object_event 42, 28, SPRITE_ROCKET, STAY, DOWN, TEXT_CELADONCITY_GRAMPS2
	object_event 22, 16, SPRITE_GRAMPS, STAY, DOWN, TEXT_CELADONCITY_GRAMPS3
	object_event 32, 2, SPRITE_ROCKET, STAY, DOWN, TEXT_CELADONCITY_FISHER
	object_event 23, 16, SPRITE_MONSTER, STAY, NONE, TEXT_CELADONCITY_POLIWRATH
	object_event 32, 29, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_CELADONCITY_ROCKET1
	object_event 30, 22, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_CELADONCITY_ROCKET2
