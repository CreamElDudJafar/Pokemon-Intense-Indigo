...
MtMoonB2F_Object:
	...
	def_object_events
	object_event 12, 8, SPRITE_ROCKET, STAY, RIGHT, TEXT_MTMOONB2F_SUPER_NERD, OPP_ENGINEER, 135
	object_event 38, 7, SPRITE_CLERK, STAY, DOWN, TEXT_MTMOONB2F_ROCKET1, OPP_SUPER_NERD, 1
	object_event 15, 26, SPRITE_ROCKET, STAY, DOWN, TEXT_MTMOONB2F_ROCKET2, OPP_ROCKET, 2
	object_event 16, 27, SPRITE_ROCKET, STAY, LEFT, TEXT_MTMOONB2F_ROCKET3, OPP_ROCKET, 3
	object_event 15, 28, SPRITE_ROCKET, STAY, UP, TEXT_MTMOONB2F_ROCKET4, OPP_ROCKET, 4
	...
	object_event 14, 27, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOONB2F_HP_UP, NUGGET
	object_event 34, 35, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOONB2F_TM_MEGA_PUNCH, TM_MEGA_PUNCH
