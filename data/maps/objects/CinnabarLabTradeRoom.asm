...
CinnabarLabTradeRoom_Object:
	...
	def_object_events
	object_event 3, 2, SPRITE_BALDING_GUY, STAY, DOWN, TEXT_CINNABARLABTRADEROOM_SUPER_NERD
	object_event 1, 4, SPRITE_GRAMPS, STAY, NONE, TEXT_CINNABARLABTRADEROOM_GRAMPS
	object_event 5, 5, SPRITE_LINK_RECEPTIONIST, STAY, UP, TEXT_CINNABARLABTRADEROOM_BEAUTY
