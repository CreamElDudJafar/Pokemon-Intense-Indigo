...
PokemonTower1F_Object:
	...
	object_event 14, 6, SPRITE_MIDDLE_AGED_WOMAN, STAY, NONE, TEXT_POKEMONTOWER1F_MIDDLE_AGED_WOMAN
	object_event 15, 6, SPRITE_LITTLE_GIRL, STAY, NONE, TEXT_POKEMONTOWER1F_BALDING_GUY
	object_event 1, 10, SPRITE_GIRL, STAY, NONE, TEXT_POKEMONTOWER1F_GIRL
	object_event 18, 7, SPRITE_CHANNELER, STAY, LEFT, TEXT_POKEMONTOWER1F_CHANNELER
