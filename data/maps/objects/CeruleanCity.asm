...
CeruleanCity_Object:
	...
	object_event 29, 12, SPRITE_GUARD, STAY, DOWN, TEXT_CERULEANCITY_GUARD1
	object_event 30, 26, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_CERULEANCITY_COOLTRAINER_F1
	object_event 31, 26, SPRITE_MONSTER, STAY, DOWN, TEXT_CERULEANCITY_SLOWBRO
