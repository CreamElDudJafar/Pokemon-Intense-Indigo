...
SilphCo2F_Object:
	...
	def_object_events
	object_event 5, 6, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO2F_SILPH_WORKER_F
	...
	object_event 23, 11, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO2F_ROCKET1, OPP_ROCKET, 28
	object_event 24, 2, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO2F_ROCKET2, OPP_ROCKET, 22
