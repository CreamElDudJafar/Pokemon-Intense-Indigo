...
SilphCo6F_Object:
	...
	object_event  3,  2, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO6F_SCIENTIST, OPP_SCIENTIST, 7
	object_event 15,  1, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO6F_ROCKET2, OPP_ROCKET, 31
	object_event 12,  9, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO6F_HP_UP, RARE_CANDY
	object_event  2, 15, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO6F_X_ACCURACY, RARE_CANDY
