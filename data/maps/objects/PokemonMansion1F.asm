...
PokemonMansion1F_Object:
	...
	object_event 7, 18, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION1F_ESCAPE_ROPE, REVIVE
	object_event 27, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION1F_CARBOS, REVIVE
