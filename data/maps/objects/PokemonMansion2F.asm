...
PokemonMansion2F_Object:
	...
	def_object_events
	object_event 13, 15, SPRITE_SAFARI_ZONE_WORKER, STAY, NONE, TEXT_POKEMONMANSION2F_SUPER_NERD, OPP_BURGLAR, 7
	object_event 28, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION2F_CALCIUM, REVIVE
