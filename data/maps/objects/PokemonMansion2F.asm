...
PokemonMansion2F_Object:
	...
	def_object_events
	object_event 12,  3, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, TEXT_POKEMONMANSION2F_SUPER_NERD, OPP_BURGLAR, 7
	object_event  1, 22, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION2F_CALCIUM, RARE_CANDY
