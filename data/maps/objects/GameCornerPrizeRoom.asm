...
GameCornerPrizeRoom_Object:
	...
	def_object_events
	object_event 1, 4, SPRITE_SAFARI_ZONE_WORKER, STAY, NONE, TEXT_GAMECORNERPRIZEROOM_BALDING_GUY
	object_event 7, 3, SPRITE_GENTLEMAN, WALK, LEFT_RIGHT, TEXT_GAMECORNERPRIZEROOM_GAMBLER
