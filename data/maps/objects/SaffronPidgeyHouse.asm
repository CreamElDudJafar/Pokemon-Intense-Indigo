...
SaffronPidgeyHouse_Object:
	...
	def_object_events
	object_event 2, 3, SPRITE_GUARD, STAY, RIGHT, TEXT_SAFFRONPIDGEYHOUSE_BRUNETTE_GIRL
	object_event 0, 4, SPRITE_BIRD, WALK, UP_DOWN, TEXT_SAFFRONPIDGEYHOUSE_PIDGEY
	object_event 4, 1, SPRITE_WAITER, STAY, DOWN, TEXT_SAFFRONPIDGEYHOUSE_YOUNGSTER
