...
SaffronCity_Object:
	...
	bg_event 37, 21, TEXT_SAFFRONCITY_TRAINER_TIPS1
	...
	bg_event 19, 23, TEXT_SAFFRONCITY_MR_PSYCHICS_HOUSE_SIGN
	bg_event  1, 19, TEXT_SAFFRONCITY_SILPH_CO_LATEST_PRODUCT_SIGN

	def_object_events
	object_event 29, 30, SPRITE_ROCKET, STAY, DOWN, TEXT_SAFFRONCITY_ROCKET1
	object_event 20, 7, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_SAFFRONCITY_ROCKET2
	object_event 34, 4, SPRITE_ROCKET, STAY, UP, TEXT_SAFFRONCITY_ROCKET3
	object_event 13, 12, SPRITE_ROCKET, STAY, NONE, TEXT_SAFFRONCITY_ROCKET4
	object_event 12, 23, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_SAFFRONCITY_ROCKET5
	...
	object_event 8, 13, SPRITE_GENTLEMAN, WALK, ANY_DIR, TEXT_SAFFRONCITY_SCIENTIST
	object_event 20, 22, SPRITE_ROCKET, STAY, NONE, TEXT_SAFFRONCITY_SILPH_WORKER_M
	...
	object_event 18, 7, SPRITE_GENTLEMAN, STAY, UP, TEXT_SAFFRONCITY_ROCKER
