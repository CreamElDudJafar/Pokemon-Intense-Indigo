...
GameCorner_Object:
	...
	def_object_events
	object_event 2, 6, SPRITE_LINK_RECEPTIONIST, STAY, DOWN, TEXT_GAMECORNER_BEAUTY1
	object_event 5, 6, SPRITE_ROCKET, STAY, DOWN, TEXT_GAMECORNER_CLERK1
	object_event 2, 10, SPRITE_SILPH_PRESIDENT, STAY, LEFT, TEXT_GAMECORNER_MIDDLE_AGED_MAN1
	object_event 2, 13, SPRITE_COOK, STAY, LEFT, TEXT_GAMECORNER_BEAUTY2
	object_event 5, 11, SPRITE_ROCKET, STAY, RIGHT, TEXT_GAMECORNER_FISHING_GURU
	object_event 8, 11, SPRITE_AGATHA, STAY, LEFT, TEXT_GAMECORNER_MIDDLE_AGED_WOMAN
	...
	object_event 14, 11, SPRITE_WARDEN, STAY, LEFT, TEXT_GAMECORNER_CLERK2
