...
SilphCo7F_Object:
	...
	object_event 18,  1, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO7F_ROCKET1, OPP_ROCKET, 32
	...
	object_event 21,  1, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO7F_ROCKET3, OPP_ROCKET, 34
	object_event  3,  7, SPRITE_BLUE, STAY, UP, TEXT_SILPHCO7F_RIVAL
	object_event  1,  9, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO7F_CALCIUM, RARE_CANDY
	object_event  7, 14, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO7F_TM_SWORDS_DANCE, RARE_CANDY
