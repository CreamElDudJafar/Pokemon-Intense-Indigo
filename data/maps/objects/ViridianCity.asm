...
ViridianCity_Object:
	...
	warp_event 29, 19, VERMILION_OLD_ROD_HOUSE, 1
	warp_event 21, 15, VIRIDIAN_MART, 1
	warp_event 21, 9, CELADON_MANSION_ROOF_HOUSE, 1
	...
	bg_event 22, 15, TEXT_VIRIDIANCITY_MART_SIGN
	bg_event 24, 25, TEXT_VIRIDIANCITY_POKECENTER_SIGN
	bg_event 31, 9, TEXT_VIRIDIANCITY_GYM_SIGN

	def_object_events
	object_event 16, 18, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER1
	object_event 27, 9, SPRITE_GAMBLER, STAY, DOWN, TEXT_VIRIDIANCITY_GAMBLER1
	object_event 32, 19, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER2
	...
	object_event 12, 10, SPRITE_FISHER, STAY, DOWN, TEXT_VIRIDIANCITY_FISHER
	object_event 32, 14, SPRITE_GAMBLER, STAY, DOWN, TEXT_VIRIDIANCITY_OLD_MAN_SLEEPY
