...
Route12_Object:
	...
	object_event 12, 94, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_ROUTE12_COOLTRAINER_M, OPP_JR_TRAINER_M, 9
	...
	object_event  4, 103, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE12_IRON, RARE_CANDY
