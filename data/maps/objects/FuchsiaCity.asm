...
FuchsiaCity_Object:
	...
	warp_event 19, 27, WARDENS_HOUSE, 1
	warp_event 27, 27, FUCHSIA_POKECENTER, 1
	warp_event 18, 3, SAFARI_ZONE_GATE, 1
	warp_event 5, 27, FUCHSIA_GYM, 1
	warp_event 22, 13, FUCHSIA_MEETING_ROOM, 1
	warp_event 31, 27, VIRIDIAN_FOREST_SOUTH_GATE, 3
	warp_event 31, 24, VIRIDIAN_FOREST_SOUTH_GATE, 2

	def_bg_events
	bg_event 25, 15, TEXT_FUCHSIACITY_SIGN1
	bg_event 21, 15, TEXT_FUCHSIACITY_SIGN2
	bg_event 27, 29, TEXT_FUCHSIACITY_SAFARI_GAME_SIGN
	bg_event  6, 13, TEXT_FUCHSIACITY_MART_SIGN
	bg_event 28, 27, TEXT_FUCHSIACITY_POKECENTER_SIGN
	bg_event 20, 27, TEXT_FUCHSIACITY_WARDENS_HOME_SIGN
	bg_event 17,  5, TEXT_FUCHSIACITY_SAFARI_ZONE_SIGN
	...
	def_object_events
	object_event 29, 19, SPRITE_SEEL, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_YOUNGSTER1
	object_event 19, 21, SPRITE_FISHER, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_GAMBLER
	object_event 35, 10, SPRITE_FISHER, STAY, DOWN, TEXT_FUCHSIACITY_ERIK
	object_event 24, 8, SPRITE_FISHER, STAY, UP, TEXT_FUCHSIACITY_YOUNGSTER2
	object_event 31, 5, SPRITE_FAIRY, WALK, ANY_DIR, TEXT_FUCHSIACITY_CHANSEY
	object_event 26, 5, SPRITE_POKE_BALL, STAY, NONE, TEXT_FUCHSIACITY_VOLTORB
	object_event 12, 4, SPRITE_MONSTER, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_KANGASKHAN
