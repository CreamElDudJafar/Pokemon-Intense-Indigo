...
CinnabarIsland_Object:
	...
	bg_event 15,  5, TEXT_CINNABARISLAND_GYM_SIGN

	def_object_events
	object_event 13,  7, SPRITE_GIRL, WALK, LEFT_RIGHT, TEXT_CINNABARISLAND_GIRL
	object_event 13,  5, SPRITE_GAMBLER, STAY, NONE, TEXT_CINNABARISLAND_GAMBLER
