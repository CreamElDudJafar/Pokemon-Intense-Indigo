...
SilphCo3F_Object:
	...
	def_object_events
	object_event 26, 3, SPRITE_ROCKET, STAY, NONE, TEXT_SILPHCO3F_SILPH_WORKER_M
	object_event 25, 1, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO3F_ROCKET, OPP_ROCKET, 23
	object_event 27, 2, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO3F_SCIENTIST, OPP_SCIENTIST, 4
	object_event 2, 15, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO3F_HYPER_POTION, REVIVE
