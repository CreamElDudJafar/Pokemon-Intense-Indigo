...
PewterNidoranHouse_Object:
	...
	object_event 3, 5, SPRITE_LITTLE_GIRL, STAY, RIGHT, TEXT_PEWTERNIDORANHOUSE_LITTLE_BOY
	object_event 1, 2, SPRITE_WAITER, WALK, NONE, TEXT_PEWTERNIDORANHOUSE_MIDDLE_AGED_MAN
