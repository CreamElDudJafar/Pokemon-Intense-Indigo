...
PokemonTower7F_Object:
	...
	def_warp_events
	warp_event 9, 16, POKEMON_TOWER_2F, 1
	...
	object_event  9,  7, SPRITE_OLD_AMBER, STAY, RIGHT, TEXT_POKEMONTOWER7F_ROCKET3, OPP_PROF_OAK, 1
	object_event 10, 3, SPRITE_BLAINE, STAY, DOWN, TEXT_POKEMONTOWER7F_MR_FUJI
