...
CeladonMart4F_Object:
	...
	object_event 15, 5, SPRITE_GENTLEMAN, WALK, LEFT_RIGHT, TEXT_CELADONMART4F_SUPER_NERD
	object_event 5, 2, SPRITE_WAITER, WALK, LEFT_RIGHT, TEXT_CELADONMART4F_YOUNGSTER
