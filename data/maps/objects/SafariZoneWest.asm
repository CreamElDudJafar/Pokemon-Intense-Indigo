...
SafariZoneWest_Object:
	...
	def_object_events
	object_event 13, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_MAX_POTION, NUGGET
	object_event  7,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_TM_DOUBLE_TEAM, RARE_CANDY
	object_event 15, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEWEST_MAX_REVIVE, RARE_CANDY
