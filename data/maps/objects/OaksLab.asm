...
OaksLab_Object:
	...
	object_event 2, 10, SPRITE_UNUSED_SCIENTIST, STAY, NONE, TEXT_OAKSLAB_SCIENTIST1
	object_event 9, 10, SPRITE_UNUSED_SCIENTIST, STAY, NONE, TEXT_OAKSLAB_SCIENTIST2
