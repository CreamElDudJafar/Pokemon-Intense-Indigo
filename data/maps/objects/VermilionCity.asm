...
VermilionCity_Object:
	...
	warp_event 7, 3, VIRIDIAN_NICKNAME_HOUSE, 1
	...
	def_object_events
	object_event 19, 7, SPRITE_SAILOR, WALK, LEFT_RIGHT, TEXT_VERMILIONCITY_BEAUTY
	object_event 15, 4, SPRITE_GUARD, STAY, NONE, TEXT_VERMILIONCITY_GAMBLER1
	object_event 19, 30, SPRITE_SAILOR, STAY, UP, TEXT_VERMILIONCITY_SAILOR1
	object_event 27, 14, SPRITE_GUARD, STAY, NONE, TEXT_VERMILIONCITY_GAMBLER2
	object_event 32, 14, SPRITE_MONSTER, WALK, UP_DOWN, TEXT_VERMILIONCITY_MACHOP
