...
VermilionPokecenter_Object:
	...
	object_event 10, 5, SPRITE_GUARD, STAY, NONE, TEXT_VERMILIONPOKECENTER_FISHING_GURU
	object_event 5, 4, SPRITE_WAITER, STAY, NONE, TEXT_VERMILIONPOKECENTER_SAILOR
	object_event 11, 2, SPRITE_GUARD, STAY, DOWN, TEXT_VERMILIONPOKECENTER_SAILOR
