...
Route9_Object:
	...
	object_event 40,  8, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE9_COOLTRAINER_F2, OPP_JR_TRAINER_F, 6
	object_event 15, 14, SPRITE_HIKER, STAY, DOWN, TEXT_ROUTE9_HIKER1, OPP_HIKER, 11
	...
	object_event 45, 15, SPRITE_HIKER, STAY, UP, TEXT_ROUTE9_HIKER3, OPP_HIKER, 5
	object_event 49,  8, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_ROUTE9_YOUNGSTER2, OPP_BUG_CATCHER, 14
