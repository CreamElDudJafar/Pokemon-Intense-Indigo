...
MtMoon1F_Object:
	...
	object_event  8, 28, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_POTION1, FIRE_STONE
	object_event  2,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_MOON_STONE, MOON_STONE
	object_event 34, 31, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_RARE_CANDY, LEAF_STONE
	object_event 10, 2,  SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_ESCAPE_ROPE, THUNDER_STONE
	object_event 29, 21, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOON1F_POTION2, WATER_STONE
