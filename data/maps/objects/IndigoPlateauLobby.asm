...
IndigoPlateauLobby_Object:
	...
	warp_event 8, 0, AGATHAS_ROOM, 1

	def_bg_events

	def_object_events
	object_event 7, 5, SPRITE_NURSE, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_NURSE
	object_event 4, 1, SPRITE_GYM_GUIDE, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_GYM_GUIDE
	object_event 12, 1, SPRITE_GUARD, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_COOLTRAINER_F
	object_event 10, 5, SPRITE_NURSE, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_CLERK
	object_event 0, 1, SPRITE_WAITER, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_GYM_GUIDE
