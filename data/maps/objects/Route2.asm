...
Route2_Object:
	...
	def_object_events
	object_event 12, 42, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE2_MOON_STONE, MOON_STONE
	object_event 12, 54, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE2_HP_UP, RARE_CANDY
