...
CeladonMart5FClerk1Text::
	script_mart TM_DIG, TM_MEGA_DRAIN, TM_SOLARBEAM, TM_PAY_DAY, TM_DOUBLE_EDGE, TM_MEGA_PUNCH, TM_MEGA_KICK
...
IndigoPlateauLobbyClerkText::
	script_mart ULTRA_BALL, CALCIUM, REVIVE, MOON_STONE, ICE_HEAL, PARLYZ_HEAL, HYPER_POTION
